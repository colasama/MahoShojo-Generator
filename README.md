...
**V0.3.0 版本【命途未定】重大更新**：引入了全新的 **随机性** 与 **可能性** 玩法！现在，你可以通过“随机组合”快速生成角色，并在竞技场中加入“随机角色”与“随机判定器”，让每一场故事都充满未知与惊喜！

**V0.2.0 版本【战斗×成长】更新**：引入了全新的**角色成长循环**！现在，你的角色可以通过参与竞技场积累“历战记录”，并通过“成长升华”功能，让角色的设定随着经历而演变和进化！

支持多个 AI 提供商，推荐使用 `gemini-1.5-flash` 模型，输入你的名字或回答问卷，即可生成专属的、可成长的魔法少女角色！
...
* **(新) 快速随机生成**：在深度问卷页面，可一键从预设素材库中随机组合生成一个完整的、可立即使用的角色，无需填写问卷。
* **魔法少女竞技场 (故事生成)**：上传2-4位参战者的设定文件（.json），AI将根据她们的设定与**历战记录**生成精彩故事。
    * **(新) 随机角色**：可在竞技场中加入“随机魔法少女”或“随机残兽”，为对局增添未知变量。
    * **(新) 随机判定器**：可像TRPG一样设置需要“掷骰”判定的事件和成功率，让AI根据判定结果演绎故事。
    * **(新) 字数选择**：可指定期望生成故事的字数（简短/标准/详细/长篇）。
