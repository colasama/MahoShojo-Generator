...
const ScenarioSchema = z.object({
  ...
  elements: z.object({
    ...
    roles: z.array(z.object({
        name: z.string().describe("角色名称或身份，例如'神秘的图书管理员'。"),
