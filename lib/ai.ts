...
export type AIGeneratedMagicalGirl = z.infer<typeof MagicalGirlGenerationSchema>

// 生成魔法少女的函数
export async function generateMagicalGirlWithAI(realName: string): Promise<AIGeneratedMagicalGirl> {
  try {
